...
# endif
	...
	sprintf(dir1, "%s/.atari800-5200/", getenv("HOME"));
	mkdir(dir1, 0777);
	free (dir1);
	dir2 = (char *)malloc(strlen(getenv("HOME")) + 24);
	sprintf(dir2, "%s/.atari800-5200/save/", getenv("HOME"));
	mkdir(dir2, 0777);
	free (dir2);
	dir3 = (char *)malloc(strlen(getenv("HOME")) + 28);
	sprintf(dir3, "%s/.atari800-5200/set/", getenv("HOME"));
	mkdir(dir3, 0777);
	free (dir3);
	dir4 = (char *)malloc(strlen(getenv("HOME")) + 28);
	sprintf(dir4, "%s/.atari800-5200/txt/", getenv("HOME"));
	mkdir(dir4, 0777);
	free (dir4);
	dir5 = (char *)malloc(strlen(getenv("HOME")) + 28);
	sprintf(dir5, "%s/.atari800-5200/kbd/", getenv("HOME"));
	mkdir(dir5, 0777);
	free (dir5);
	dir6 = (char *)malloc(strlen(getenv("HOME")) + 28);
	sprintf(dir6, "%s/.atari800-5200/joy/", getenv("HOME"));
	mkdir(dir6, 0777);
	free (dir6);
	dir7 = (char *)malloc(strlen(getenv("HOME")) + 28);
	sprintf(dir7, "%s/.atari800-5200/cht/", getenv("HOME"));
	mkdir(dir7, 0777);
	free (dir7);
	dir8 = (char *)malloc(strlen(getenv("HOME")) + 28);
	sprintf(dir8, "%s/.atari800-5200/scr/", getenv("HOME"));
	mkdir(dir8, 0777);
	free (dir8);
	dir9 = (char *)malloc(strlen(getenv("HOME")) + 28);
	sprintf(dir9, "%s/.atari800-5200/roms/", getenv("HOME"));
	mkdir(dir9, 0777);
	free (dir9);
#endif;
...
#if defined(GCW0_MODE) || defined(DINGUX_MODE)
	sprintf(ATARI.atari_home_dir, "%s/.atari800-5200/", getenv("HOME"));
#else
...
{
  if (ATARI.atari_current_clock != a_clock) {
    scePowerSetClockFrequency(a_clock, a_clock, a_clock/2);
    ATARI.atari_current_clock = a_clock;
  }
}
